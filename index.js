...
function askQuestion(index) {
  ...
  let check = prompt("Do you want to change your answer? Yes or No: ")

  if (check == "Yes") {
    guess = prompt("Guess another one: ")
  } else {
  }
...
while (condition) {
  ...
  let want = prompt("Do you want to play this game again? Yes or No")
  if (want == "Yes") {
  } else {
    condition = false
  }
